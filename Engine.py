...
class Engine:
  ...
  def Solve(self,pr):
    ...
    subprocess.call(["glpsol", "--math", "Model/model.mod", "--data", "Model/model.dat", "--tmlim","180", "--write", "Output/write.out"])
    #subprocess.call(["glpsol", "--math", "Model/model.mod", "--data", "Model/model.dat", "--tmlim","180", "--output", "Output/output.out"])
    return pr.solution()
